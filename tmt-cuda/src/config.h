...
#define TMT_CONFIG(F) \
    ...
    F(int, maxcarry, 0) F(int, seed, 1234) F(int, traces, 0) F(int, origtrace, 0) F(float, trace_decay, 1.f) F(int, docsep, -1) \
...
static void validate_cfg(const Cfg& c) {
    ...
    require(c.origtrace == 0 || c.origtrace == 1, "origtrace must be 0 or 1");
